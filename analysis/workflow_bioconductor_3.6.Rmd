...
paste0(
  "Mitochondrial genes removed: ", no_mito, "
   Number of genes remaining:", dim(sce)[1]
)
...
paste0(
  "Low-abundance genes removed: ", sum(!keep_genes), "
   Number of genes remaining:", dim(sce)[1]
)
```
...
plot_dat$apoptotic <- colMeans(counts(sce)[index_apoptotic, ])/plot_dat$umi
